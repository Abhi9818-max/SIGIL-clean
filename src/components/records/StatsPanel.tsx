...
const StatsPanel: React.FC<StatsPanelProps> = ({ selectedTaskFilterId }) => {
  const { getAggregateSum, getDailyConsistencyLast30Days, getTaskDefinitionById } = useUserRecords();
  ...
  }, [getDailyConsistencyLast30Days, selectedTaskFilterId, getTaskDefinitionById]);
